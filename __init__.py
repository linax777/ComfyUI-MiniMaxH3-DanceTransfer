...
NODE_CLASS_MAPPINGS = {
    ...
    DANCE_NODE_IDS["finite_audio_crossfade_join"]: MiniMaxH3DanceFiniteAudioCrossfadeJoin,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    DANCE_NODE_IDS["finite_audio_crossfade_join"]: "MiniMax H3 Dance Finite Audio Crossfade Join (Internal)",
